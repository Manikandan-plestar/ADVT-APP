...
class _CreateBusinessScreenState extends State<CreateBusinessScreen> {
  ...
  void _submitNewBusiness() async {
    ...
    if (_selectedImages.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please select 1 to 4 business images from your device.')),
      );
      return;
    }
    ...
    final newBiz = await bizService.createBusinessProfile(
      ...
      registeredAddress: 'Tirunelveli, Tamil Nadu',
      latitude: 8.7139,
      longitude: 77.7567,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 3. Business Phone Number with FoneBook Country Code Selector
            ...
            // 4. Business Images (1 to 4 Images - Local Device Only)
            Row(
